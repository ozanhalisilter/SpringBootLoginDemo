...
import com.example.springbootlogindemo.email.EmailSender;
import com.example.springbootlogindemo.email.EmailService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        emailService.send(request.getEmail(), buildEmail(request.getFirstName(), "https://localhost:8080/api/v1/registration/confirm?token=" + token));
        return token;
    }
